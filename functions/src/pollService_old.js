 ...
 */
const updatePoll = functions.https.onRequest((req, res) => {
  cors(req, res, async () => {
    try {
      const userId = req.user?.uid;
 ...
 * Delete a poll
 */
const deletePoll = functions.https.onRequest((req, res) => {
  cors(req, res, async () => {
    try {
      const userId = req.user?.uid;
      const pollId = req.query.pollId;
 ...
 */
const finalizePoll = functions.https.onRequest((req, res) => {
  cors(req, res, async () => {
    try {
      const userId = req.user?.uid;
      const pollId = req.query.pollId;
 ...
 */
const getPollResults = functions.https.onRequest((req, res) => {
  cors(req, res, async () => {
    try {
      const userId = req.user?.uid;
      const pollId = req.query.pollId;
